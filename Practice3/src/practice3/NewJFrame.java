...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("База данных жителей города");
        ...
        jLabel7.setText("Выберите ID для удаления");
        ...
        jLabel2.setText("Время проживания");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String v = jSpinner2.getValue().toString();
        mn.insert(n, t, l, v);
        mn.show();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         int tempId = (Integer)jSpinner1.getValue(); 
           //String tempId = Spinner1.getValue().toString(); 
