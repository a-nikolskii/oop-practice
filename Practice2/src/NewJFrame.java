  ...
  MyTableModel mtm = new MyTableModel();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Название", "Цена за шт", "Колво", "Стоимость"
            }
        ));
        ...
        jLabel2.setText("Цена за шт");

        jLabel3.setText("Колво");

        jLabel4.setText("Добавить");

        jLabel5.setText("Удалить");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cost = Double.toString(Double.parseDouble(price) * Double.parseDouble(count));
        ...
        jSpinner1.setValue(1);
        jTextField1.requestFocus();
        sum();     // TODO add your handling code here:
